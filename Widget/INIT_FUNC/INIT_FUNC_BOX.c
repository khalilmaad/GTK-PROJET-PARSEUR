...
void init_box(Widget* obj)
{
    ...
    char* tableau_enfant[] = {"spinner","levelbar","progressbar","linkbutton","buttonbox","flowbox","listbox","revealer","layout","fixed","expander","notebook","stack","stackswitcher","grid",
