...
{
    obj->Widget_Ptr = gtk_grid_new();

    Attributs tableau_attribut[] =
    {
        {"espacement_colonne",  strdup("")},
        {"espacement_ligne",  strdup("")},
        {"homogeneite_colonne",strdup("false")},
        {"homogeneite_ligne",strdup("false")},
        {"couleur_fond",           strdup("")},
        {"coin_arrondi",           strdup("")},
        {"margin",           strdup("")},
        {"margin_top",           strdup("")},
    ...
    char* tableau_enfant[] = {"searchentry","entry","scrollbar","overlay","menuitem","menubar","menu","label","image",
    ...
    obj->apply_attribut_func = apply_attribut_grid;
    obj->set_child = set_child_grid;
